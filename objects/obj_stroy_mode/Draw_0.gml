...
for (var a = 0;a < array_length(test_need_draw);a++) {
	...
	draw_text_bet_ext(string(test_need_draw[a].weekName),1280/2-100,(550 + 100 * a) + -ui_y,1,1,0,0,image_alpha)
...
draw_text(1278,5,test_need_draw[choose_setting].storyName)
...
for (var i = 0;i < array_length(test_need_draw[choose_setting].songs);i++) {
	draw_text_transformed(120,550+i * 38,test_need_draw[choose_setting].songs[i][0],0.85,0.85,0)
