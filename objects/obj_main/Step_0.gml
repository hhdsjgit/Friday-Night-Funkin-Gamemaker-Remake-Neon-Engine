...
global.Game_inf.Game_song_speed = 1.8//sin(Game_start_pos_time)/1.2 + 1
...
switch Game_start_pos {
	case 1: if Game_start_pos_time >= 0.1 {func_play_sounds("/game_assets/sounds/minus/1.ogg",0,0);Game_start_pos ++};break;
	case 2: if Game_start_pos_time >= 0.5 {func_play_sounds("/game_assets/sounds/minus/2.ogg",0,0);Game_start_pos ++};break;
	case 3: if Game_start_pos_time >= 1 {func_play_sounds("/game_assets/sounds/minus/3.ogg",0,0);Game_start_pos ++};break;
	case 4: if Game_start_pos_time >= 1.5 {func_play_sounds("/game_assets/sounds/minus/4.ogg",0,0);Game_start_pos ++};break;
...
if keyboard_check(vk_control) {
	...
	if mouse_wheel_down() {
		global.Game_inf.Game_song_speed -= 0.05
	}
	if mouse_wheel_up() {
		global.Game_inf.Game_song_speed += 0.05
	}
...
if array_length(global.Song_information.notes_data) > i and global.Game_inf.player_die != true{
	...
	if array_length(note_1.sectionNotes) >= 1 {
		...
		var song_time_add = 900 / clamp(global.Game_inf.Game_song_speed,-1,1)
